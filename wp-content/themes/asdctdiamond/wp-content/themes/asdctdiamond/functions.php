...
require_once('asdc-vc-functions.php'); // Let's add the Visual Composer shortcodes
...
function set_asdc_image_size() {
    $sizes = array(
        ...
        'home-about' => array('w' => 454, 'h' => 376, 'c' => true, 't' => 'home-about'),
    );
    return $sizes;
}
